...
<div>
  ...
  <!-- Content Section: Smarter Lab Spaces -->
      ...
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div class="relative text-base mx-auto max-w-prose lg:max-w-none">
            <figure>
              <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                <img class="rounded-lg shadow-lg object-cover object-center" src="~assets/images/lab_lady.jpg" alt="RFID enabled lab spaces allow for tracking of equipment, tooling, and supplies" width="1184" height="1376">
              </div>
              <figcaption class="mt-3 flex text-sm text-gray-500">
                ...
                <span class="ml-2">RFID-enabled lab space allows for tracking of equipment, tools, and supplies</span>
              </figcaption>
            </figure>
          </div>
        </div>
        <div class="mt-8 lg:mt-0">
          ...
          <div class="mt-5 prose prose-indigo text-gray-700 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
            <ul role="list" class="text-lg text-gray-500">
              <li>Track equipment with 100% accuracy</li>
            ...
            <dl class="ml-1 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:grid-rows-4 sm:grid-flow-col sm:gap-x-6 sm:gap-y-10 lg:gap-x-8">
              <div class="relative">
                <dt>
                  ...
                  <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Consumables and supplies</p>
                </dt>
                <dt>
                  <svg class="absolute h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Lab equipment and calibration data</p>
                </dt>
                <dt>
                  <svg class="absolute h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Chemicals and referigerated items</p>
                </dt>
                <dt>
                  <svg class="absolute h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Perishables, including time-out-of-temperature remaining</p>
                </dt>
              </div>
            </dl>
          </div>
  ...
  <div class="py-32 bg-gradient-to-tl from-gray-900 to-gray-800">
    <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <h2 class="sr-only">RFID for Medical Device and Drug Manufacturers</h2>
