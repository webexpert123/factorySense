  ...
  <div class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Drive savings and increase traceability</h2>
        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">WIP and Kits</p>
            </dt>
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Inventory: Eliminate Shortages</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Geofencing: Catch Escapes</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Equipment and Assets</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
