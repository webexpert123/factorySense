...
<div>
  ...
  <div class="py-24 bg-gray-50 sm:py-32">
    <div class="max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
      <h1 class="font-Lora font-semibold text-4xl leading-10 tracking-tight text-gray-900 text-center sm:text-5xl sm:leading-none lg:text-6xl">
        FactorySense provides out-of-the-box and time-tested RFID configurations tailored for electronics manufacturers
      </h1>
  ...
  <div class="relative bg-gray-800">
    <div class="h-56 bg-indigo-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
      <img class="w-full h-full object-cover" src="~assets/images/plant-readers-1.jpg" alt="">
    </div>
    <div class="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div class="md:ml-auto md:w-1/2 md:pl-10">
        <h2 class="font-Lora font-semibold text-base uppercase tracking-wider text-gray-300">
          Rapid Deployment
        </h2>
        <p class="font-Lora font-semibold mt-2 text-white text-3xl tracking-tight sm:text-4xl">
          Drive massive ROI
        </p>
  ...
  <div class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <h2 class="font-Lora font-semibold text-base text-indigo-600 tracking-wide uppercase">Drive savings and increase traceability</h2>
        <p class="font-Lora font-semibold mt-2 text-3xl leading-8 tracking-tight text-gray-900 sm:text-4xl">
        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="font-Lora ml-16 text-lg leading-6 font-medium text-gray-900">WIP and Kits</p>
            </dt>
          ...
          <div class="relative">
            <dt>
              ...
              <p class="font-Lora ml-16 text-lg leading-6 font-medium text-gray-900">Inventory: Eliminate Shortages</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="font-Lora ml-16 text-lg leading-6 font-medium text-gray-900">Geofencing: Catch Escapes</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="font-Lora ml-16 text-lg leading-6 font-medium text-gray-900">Equipment and Assets</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
