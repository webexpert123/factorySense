...
<div>
  <div class="py-24 bg-white sm:py-32">
    <div class="max-w-md mx-auto sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
      <h1 class="text-4xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-5xl sm:leading-none lg:text-6xl">Privacy Policy</h1>
      ...
      <h3 class="mt-6 text-2xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-xl sm:leading-none lg:text-xl">Billing Information</h3>
      <p class="text-xl leading-normal">
      ...
      <h3 class="mt-6 text-2xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-xl sm:leading-none lg:text-xl">Geolocation Data</h3>
      <p class="text-xl leading-normal">
      ...
      <h3 class="mt-6 text-2xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-xl sm:leading-none lg:text-xl">Website Interactions</h3>
      <p class="text-xl leading-normal">
      ...
      <h2 class="mt-6 text-2xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-3xl sm:leading-none lg:text-3xl">When we access or share your information</h2>
      <p class="text-xl leading-normal">
