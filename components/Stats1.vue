    ...
    <div class="relative max-w-7xl mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:py-16">
      <div class="max-w-2xl mx-auto lg:max-w-none lg:mr-0 lg:ml-auto lg:w-1/2 lg:pl-10">
        ...
        <h2 class="mt-6 text-3xl font-extrabold text-gray-900 sm:text-4xl">
          Delivering value to enterprises at scale around the world
        </h2>
        <p class="mt-6 text-lg text-gray-500">
          Manufacturers from America to Asia have chosen FactorySense RFID for our rapid deployment ability, cloud-scale infrastructure and security, and ability to execute projects that deliver maximum ROI.
        </p>
