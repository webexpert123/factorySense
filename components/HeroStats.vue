    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
      <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
        ...
        <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
          ...
          <p>
            <span class="block text-2xl font-bold text-white">ONE</span>
            <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Supplier</span> for everything needed for your RFID system to work. FactorySense provides consulting, hardware, and cloud-based software as an integrated and cost-efficient platform.</span>
          </p>
        </div>
      </div>
    </div>
